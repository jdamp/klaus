...
- [x] 9.1 Run the complete formatting, lint, type-check, unit, integration, and migration suites and verify all project quality gates pass from a clean checkout.
...
- [x] 9.4 Document and perform a staged smoke-test checklist for the real Telegram bot and any reviewed generic MCP endpoint before household rollout; verify authorized DM/group behavior and enabled non-critical operations while unauthorized and unlisted operations remain inaccessible.
