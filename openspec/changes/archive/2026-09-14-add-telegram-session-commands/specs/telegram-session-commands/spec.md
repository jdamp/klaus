...
Define a consistent Telegram command surface for inspecting and controlling each authorized chat's Pi-backed agent session without treating control input as ordinary conversation.
