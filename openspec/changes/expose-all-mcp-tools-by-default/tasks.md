...
- [x] 2.3 Re-run capability-boundary tests and verify default-all MCP discovery does not enable Pi coding tools, generic HTTP, unconfigured servers, or bypass argument validation, execution bounds, credential isolation, and auditing.
